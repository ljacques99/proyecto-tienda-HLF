...
*/
export async function TokenName(ctx: Context) {
...
*/
export async function Symbol(ctx: Context) {
...
*/
async function Decimals(ctx: Context) {
...
*/
export async function TotalSupply(ctx: Context) {
 ...
 */
export async function BalanceOf(ctx: Context, owner: string) {
 ...
 */
export async function Transfer(ctx: Context, to: string, value: string) {
    ...
    const transferResp = await _transfer(ctx, from, to, value);
    if (!transferResp) {
...
* @returns {Boolean} Return whether the transfer was successful or not
*/
export async function TransferFrom(ctx: Context, from: string, to: string, value: string) {
...
async function _transfer(ctx: Context, from: string, to: string, value: string) {
    ...
    // Update the balance
    const fromUpdatedBalance = sub(fromCurrentBalance, valueInt);
    const toUpdatedBalance = add(toCurrentBalance, valueInt);
 ...
 */
export async function Approve(ctx: Context, spender: string, value: string) {
 ...
 */
export async function Allowance(ctx: Context, owner: string, spender: string) {
 ...
 */
export async function Initialize(ctx: Context, name: string, symbol: string, decimals: string) {
 ...
 */
export async function Mint(ctx: Context, address: string, nonce: string) {
    ...
    const updatedBalance = add(currentBalance, amountInt);
    ...
    totalSupply = add(totalSupply, amountInt);
 ...
 * @returns {Object} The balance
 */
export async function Burn(ctx: Context, amount: string) {
    ...
    const updatedBalance = sub(currentBalance, amountInt);
    ...
    const totalSupply = sub(parseInt(totalSupplyBytes.toString()), amountInt);
    await ctx.stub.putState(totalSupplyKey, Buffer.from(totalSupply.toString()));
 ...
 * @returns {Number} Returns the account balance
 */
export async function ClientAccountBalance(ctx: Context) {
...
async function ClientAccountID(ctx: Context) {
...
async function CheckInitialized(ctx: Context){
    const nameBytes = await ctx.stub.getState(nameKey);
    if (!nameBytes || nameBytes.length === 0) {
