    ...
    <div className="block rounded-lg bg-white shadow-md text-center transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg h-full flex flex-col">
      ...
      <div className="p-6 flex-1 flex flex-col justify-between">
        <div>
          ...
          <p className="mt-1 text-lg font-medium text-gray-900">${formatPrice(product.priceInt)}</p>
        </div>
        <button className="mt-4 w-full text-white bg-brandTwo hover:bg-opacity-75 focus:ring-4 focus:outline-none focus:ring-brandTwo font-medium rounded-lg text-sm px-5 py-2.5 text-center"  onClick={handleDeleteProduct}>
          Delete Product
        </button>
