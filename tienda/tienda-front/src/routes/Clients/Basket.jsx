    ...
    <div className="bg-white py-12">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <li key={`${item.id}-${item.merchantId}`} className="flex items-center py-6 space-x-6">
              ...
              <div className="flex flex-1 justify-between items-center">
                ...
                <div className="flex items-center">
                  <span className="text-sm font-medium text-gray-900">${formatPrice(item.priceInt)}</span>
        ...
        <div className="mt-8">
          ...
          <div className="mt-6">
            <button onClick={handleCheckOut} className="w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700">Checkout</button>
          </div>
        </div>
      </div>
    </div>
